 ...
 * <em>blacklist</em> of words from a file; then, reading in a sequence of words
 * from standard input, printing out each word that <em>does not</em> appear in
 * the file. It is useful as a test client for various symbol table
 * implementations.
 * <p>
