...
/**
 * The {@code Complex} class represents a complex number. Complex numbers are
 * immutable: their values cannot be changed after they are created. It includes
 * methods for addition, subtraction, multiplication, division, conjugation, and
 * other common functions on complex numbers.
 * <p>
...
public class Complex {
	 ...
	 *
	 * @return a string representation of this complex number, of the form 34 -
	 *         56i.
	 */
	...
	/**
	 * Returns the absolute value of this complex number. This quantity is also
	 * known as the <em>modulus</em> or <em>magnitude</em>.
	 *
	...
	/**
	 * Returns the phase of this complex number. This quantity is also known as
	 * the <em>angle</em> or <em>argument</em>.
	 *
	 * @return the phase of this complex number, a real number between -pi and
	 *         pi
	 */
	public double phase() {
	...
	/**
	 * Returns the result of subtracting the specified complex number from this
	 * complex number.
	 *
	 * @param that
	 *            the other complex number
	...
	/**
	 * Returns the product of this complex number and the specified complex
	 * number.
	 *
	 * @param that
	 *            the other complex number
	...
	/**
	 * Returns the result of dividing the specified complex number into this
	 * complex number.
	 *
	 * @param that
	 *            the other complex number
