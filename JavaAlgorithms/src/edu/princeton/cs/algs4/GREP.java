...
/**
 * The {@code GREP} class provides a client for reading in a sequence of lines
 * from standard input and printing to standard output those lines that contain
 * a substring matching a specified regular expression.
 * <p>
...
public class GREP {
	...
	/**
	 * Interprets the command-line argument as a regular expression (supporting
	 * closure, binary or, parentheses, and wildcard) reads in lines from
	 * standard input; writes to standard output those lines that contain a
