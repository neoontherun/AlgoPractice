...
/**
 * The {@code CPM} class provides a client that solves the parallel
 * precedence-constrained job scheduling problem via the <em>critical path
 * method</em>. It reduces the problem to the longest-paths problem in
 ...
 * and computes the longest-paths lengths (which are precisely the start times
 * for each job).
 * <p>
