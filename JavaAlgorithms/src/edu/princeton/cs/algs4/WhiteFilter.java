...
/**
 * The {@code WhiteFilter} class provides a client for reading in a
 * <em>whitelist</em> of words from a file; then, reading in a sequence of words
 * from standard input, printing out each word that appears in the file. It is
