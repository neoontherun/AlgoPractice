...
/**
 * The {@code GaussianElimination} data type provides methods to solve a linear
 * system of equations <em>Ax</em> = <em>b</em>, where <em>A</em> is an
 * <em>m</em>-by-<em>n</em> matrix and <em>b</em> is a length <em>n</em> vector.
 * <p>
 * This is a bare-bones implementation that uses Gaussian elimination with
 * partial pivoting. See <a href =
 * "https://algs4.cs.princeton.edu/99scientific/GaussianEliminationLite.java.html">GaussianEliminationLite.java</a>
 * for a stripped-down version that assumes the matrix <em>A</em> is square and
 * nonsingular. See {@link GaussJordanElimination} for an alternate
 * implementation that uses Gauss-Jordan elimination. For an industrial-strength
 * numerical linear algebra library, see
...
public class GaussianElimination {
	 ...
	 * <em>A</em> is an <em>m</em>-by-<em>n</em> matrix and <em>b</em> is a
	 * length <em>m</em> vector.
	 *
	 * @param A
	 ...
	 *             if the dimensions disagree, i.e., the length of {@code b}
	 *             does not equal {@code m}
	 */
