...
/**
 * The {@code GraphGenerator} class provides static methods for creating various
 * graphs, including Erdos-Renyi random graphs, random bipartite graphs, random
 * k-regular graphs, and random rooted trees.
 * <p>
...
public class GraphGenerator {
	...
	/**
	 * Returns a random simple graph containing {@code V} vertices and {@code E}
	 * edges.
	 * 
	 * @param V
	...
	/**
	 * Returns a random simple graph on {@code V} vertices, with an edge between
	 * any two vertices with probability {@code p}. This is sometimes referred
	 * to as the Erdos-Renyi random graph model.
	 * 
	 * @param V
	 *            the number of vertices
	 * @param p
	...
	/**
	 * Returns a random simple bipartite graph on {@code V1} and {@code V2}
	 * vertices with {@code E} edges.
	 * 
	 * @param V1
	 *            the number of vertices in one partition
	 * @param V2
	 ...
	 * @param E
	 *            the number of edges
	 * @return a random simple bipartite graph on {@code V1} and {@code V2}
	 *         vertices, containing a total of {@code E} edges
	 * @throws IllegalArgumentException
	...
	/**
	 * Returns a random simple bipartite graph on {@code V1} and {@code V2}
	 * vertices, containing each possible edge with probability {@code p}.
	 * 
	 * @param V1
	 *            the number of vertices in one partition
	 * @param V2
	 *            the number of vertices in the other partition
	 * @param p
	 *            the probability that the graph contains an edge with one
	 *            endpoint in either side
	 * @return a random simple bipartite graph on {@code V1} and {@code V2}
	 *         vertices, containing each possible edge with probability
	 *         {@code p}
	 * @throws IllegalArgumentException
	 *             if probability is not between 0 and 1
	 */
	 ...
	 * @return a graph that is an Eulerian cycle on {@code V} vertices and
	 *         {@code E} edges
	 * @throws IllegalArgumentException
	 ...
	 * @return a graph that is an Eulerian path on {@code V} vertices and
	 *         {@code E} edges
	 * @throws IllegalArgumentException
	 *             if either {@code V <= 0} or {@code E < 0}
	 */
	 ...
	 * (not necessarily simple). The graph is simple with probability only about
	 * e^(-k^2/4), which is tiny when k = 14.
	 *
	 * @param V
	...
	/**
	 * Returns a uniformly random tree on {@code V} vertices. This algorithm
