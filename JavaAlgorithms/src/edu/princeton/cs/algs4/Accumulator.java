...
/**
 * The {@code Accumulator} class is a data type for computing the running mean,
 * sample standard deviation, and sample variance of a stream of real numbers.
 * It provides an example of a mutable data type and a streaming algorithm.
 * <p>
 ...
 * based on saving the sum of the squares of the numbers. This technique is due
 * to <a href =
 * "https://en.wikipedia.org/wiki/Algorithms_for_calculating_variance#Online_algorithm">B.
 * P. Welford</a>. Each operation takes constant time in the worst case. The
...
public class Accumulator {
	...
	/**
	 * Unit tests the {@code Accumulator} data type. Reads in a stream of real
	 * number from standard input; adds them to the accumulator; and prints the
	 * mean, sample standard deviation, and sample variance to standard output.
	 *
	 * @param args
