...
/**
 * The {@code NonrecursiveDFS} class represents a data type for finding the
 ...
 * explicit stack. See {@link DepthFirstSearch} for the classic recursive
 * version. The constructor takes time proportional to <em>V</em> + <em>E</em>,
 * where <em>V</em> is the number of vertices and <em>E</em> is the number of
 * edges. It uses extra space (not including the graph) proportional to
 * <em>V</em>.
 * <p>
...
public class NonrecursiveDFS {
	...
	/**
	 * Computes the vertices connected to the source vertex {@code s} in the
	 * graph {@code G}.
	 * 
	 * @param G
	 *            the graph
	 ...
	 * @param v
	 *            the vertex
	 * @return {@code true} if vertex {@code v} is connected to the source
	 *         vertex {@code s}, and {@code false} otherwise
	 * @throws IllegalArgumentException
	 *             unless {@code 0 <= v < V}
	 */
