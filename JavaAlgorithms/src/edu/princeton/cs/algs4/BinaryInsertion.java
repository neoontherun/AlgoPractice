 ...
 * However, in the worst case, the running time is quadratic because the number
 * of array accesses can be proportional to n^2 (e.g, if the array is reverse
 * sorted). As such, it is not suitable for sorting large arrays (unless the
