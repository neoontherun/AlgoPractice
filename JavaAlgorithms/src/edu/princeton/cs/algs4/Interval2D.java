 ...
 * {@code ymin <= y <= ymax}. Two-dimensional intervals are immutable: their
 * values cannot be changed after they are created. The class {@code Interval2D}
 * includes methods for checking whether a two-dimensional interval contains a
 * point and determining whether two two-dimensional intervals intersect.
 * <p>
