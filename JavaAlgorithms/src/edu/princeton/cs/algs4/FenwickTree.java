...
public class FenwickTree {
	...
	/**
	 * Range Sum Query from a to b. Search for the sum from array index from a
	 * to b a and b are 1-indexed
	 * <p>
	 * Time-Complexity: O(log(n))
	 *
	 * @param a
	 ...
	 * zeroes set a b c Initializes the array with [a, b, c ...] rsq a b Range
	 * Sum Query for the range [a,b] up i v Update the i position of the array
	 * with value v. exit
	 * <p>
	 * The array is 1-indexed Example: set 1 2 3 4 5 6 rsq 1 3 Sum from 1 to 3 =
	 * 6 rmq 1 3 Min from 1 to 3 = 1 input up 1 3 [3,2,3,4,5,6]
	 *
	 * @param args
