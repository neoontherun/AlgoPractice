 ...
 * <em>V</em> is the number of vertices. Afterwards, the {@code dist()},
 * {@code hasPath()}, and {@code hasNegativeCycle()} methods take constant time;
 * the {@code path()} and {@code negativeCycle()} method takes time proportional
 * to the number of edges returned.
 * <p>
...
public class FloydWarshall {
	...
	private DirectedEdge[][] edgeTo; // edgeTo[v][w] = last edge on shortest
										// v->w path
