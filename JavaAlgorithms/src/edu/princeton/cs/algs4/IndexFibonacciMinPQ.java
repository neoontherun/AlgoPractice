...
public class IndexFibonacciMinPQ<Key> implements Iterable<Integer> {
	...
	private HashMap<Integer, Node<Key>> table = new HashMap<Integer, Node<Key>>(); // Used
																					// for
																					// the
																					// consolidate
																					// operation
	 ...
	 * {@code 0} and {@code N-1} Worst case is O(n)
	 * 
	 * @param N
	 *            number of keys in the priority queue, index from {@code 0} to
	 *            {@code N-1}
