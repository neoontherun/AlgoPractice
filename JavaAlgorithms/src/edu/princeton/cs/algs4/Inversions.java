...
/**
 * The {@code Inversions} class provides static methods to count the number of
 * <em>inversions</em> in either an array of integers or comparables. An
 * inversion in an array {@code a[]} is a pair of indicies {@code i} and
 * {@code j} such that {@code i < j} and {@code a[i] > a[j]}.
 * <p>
 * This implementation uses a generalization of mergesort. The <em>count</em>
 * operation takes time proportional to <em>n</em> log <em>n</em>, where
 * <em>n</em> is the number of keys in the array.
 * <p>
...
public class Inversions {
	...
	/**
	 * Returns the number of inversions in the integer array. The argument array
	 * is not modified.
	 * 
	 * @param a
	 *            the array
	...
	/**
	 * Returns the number of inversions in the comparable array. The argument
