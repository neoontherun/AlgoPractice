...
public class Counter implements Comparable<Counter> {
	 ...
	 * @param that
	 *            the other counter
	 * @return {@code 0} if the value of this counter equals the value of that
	 *         counter; a negative integer if the value of this counter is less
	 *         than the value of that counter; and a positive integer if the
	 *         value of this counter is greater than the value of that counter
	 */
	@Override
