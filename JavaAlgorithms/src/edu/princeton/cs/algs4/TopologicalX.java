...
/**
 * The {@code TopologicalX} class represents a data type for determining a
 ...
 * number of edges. Afterwards, the <em>hasOrder</em> and <em>rank</em>
 * operations takes constant time; the <em>order</em> operation takes time
 ...
 * is not a DAG. See {@link Topological} for a recursive version that uses
 * depth-first search.
 * <p>
