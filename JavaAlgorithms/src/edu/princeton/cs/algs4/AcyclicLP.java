 ...
 * single-source longest paths problem in edge-weighted directed acyclic graphs
...
public class AcyclicLP {
	...
	/**
	 * Computes a longest paths tree from {@code s} to every other vertex in the
	 ...
	 *         vertex {@code v}; {@code Double.NEGATIVE_INFINITY} if no such
	 *         path
	 * @throws IllegalArgumentException
	 *             unless {@code 0 <= v < V}
	 */
	...
	/**
	 * Returns a longest path from the source vertex {@code s} to vertex
	 * {@code v}.
	 * 
	 * @param v
	 *            the destination vertex
	 * @return a longest path from the source vertex {@code s} to vertex
