 ...
 * coefficients. Polynomials are immutable: their values cannot be changed after
 * they are created. It includes methods for addition, subtraction,
 * multiplication, composition, differentiation, and evaluation.
 * <p>
...
public class Polynomial {
	 ...
	 *         polynomial (precisely when {@code equals()} returns
	 *         {@code true}); a negative integer if this polynomialt is less
	 *         than the argument polynomial; and a positive integer if this
	 *         polynomial is greater than the argument point
	 */
