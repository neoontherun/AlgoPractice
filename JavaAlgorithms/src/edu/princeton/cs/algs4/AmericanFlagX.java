...
/**
 * The {@code AmericanFlagX} class provides static methods for sorting an array
 * of extended ASCII strings or integers in-place using American Flag sort. This
 * implementation is non-recursive and uses only one auxiliary array.
 * <p>
 * For additional documentation, see
 * <a href="https://algs4.cs.princeton.edu/51radix">Section 5.1</a> of
 * <i>Algorithms, 4th Edition</i> by Robert Sedgewick and Kevin Wayne and
 * <a href =
 * "http://static.usenix.org/publications/compsystems/1993/win_mcilroy.pdf">
 * Engineering Radix Sort</a> by McIlroy and Bostic. For a version that uses two
 * auxilary arrays, see {@link AmericanFlag}.
 *
 * @author Ivan Pesin
 */
...
public class AmericanFlagX {
	...
	/**
	 * Rearranges the array of extended ASCII strings in ascending order. This
	 * is an unstable in-place sorting algorithm.
	 *
	 * @param a
	...
	public static void sort(String[] a, int lo, int hi) {
		...
		while (!st.isEmpty()) {
			...
			for (int i = lo; i <= hi; i++) {
				int c = charAt(a[i], d) + 1; // account for -1 representing
												// end-of-string
				count[c]++;
			}
			...
			// for details and proof see Knuth Theorem 5.1.2B and ch 5.2
			// excercise 13.
			for (int r = hi; r >= lo; r--) {
	 ...
	 * standard input; American flag sorts them; and prints them to standard
