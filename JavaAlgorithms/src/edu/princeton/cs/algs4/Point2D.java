...
public final class Point2D implements Comparable<Point2D> {
	 ...
	 * (x1, y1) if and only if either {@code y0 < y1} or if {@code y0 == y1} and
	 * {@code x0 < x1}.
	 *
	 * @param that
	 *            the other point
	 * @return the value {@code 0} if this string is equal to the argument
	 *         string (precisely when {@code equals()} returns {@code true}); a
	 *         negative integer if this point is less than the argument point;
	 ...
	 * @param other
	 *            the other point
	 * @return {@code true} if this point equals {@code other}; {@code false}
	 *         otherwise
	 */
	@Override
