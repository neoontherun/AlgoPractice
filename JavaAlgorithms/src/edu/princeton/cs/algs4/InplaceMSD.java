...
/**
 * The {@code InplaceMSD} class provides static methods for sorting an array of
 * extended ASCII strings using in-place MSD radix sort.
 * <p>
...
public class InplaceMSD {
	 ...
	 * in-place MSD radix sorts them; and prints them to standard output in
	 * ascending order.
	 *
	 * @param args
