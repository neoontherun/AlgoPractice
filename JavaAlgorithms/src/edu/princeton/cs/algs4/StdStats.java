...
public final class StdStats {
	 ...
	 * @param a
	 *            the array
	 * @return the average value in the array {@code a[]}; {@code Double.NaN} if
	 *         no such value
	 */
	 ...
	 * @param a
	 *            the array
	 * @return the sample variance in the array {@code a[]}; {@code Double.NaN}
	 *         if no such value
	 */
	 ...
	 *         {@code a[lo..hi)}; {@code Double.NaN} if no such value
	 * @throws IllegalArgumentException
	 *             if {@code a} is {@code null}
	 * @throws IllegalArgumentException
	 *             unless {@code (0 <= lo) && (lo < hi) && (hi <= a.length)}
	...
	/**
	 * Plots the points (0, <em>a</em><sub>0</sub>), (1,
	 * <em>a</em><sub>1</sub>), ..., (<em>n</em>-1,
