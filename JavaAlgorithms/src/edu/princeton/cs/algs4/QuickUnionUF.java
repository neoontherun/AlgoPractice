 ...
 * <em>n</em> sites takes linear time. Afterwards, the <em>union</em>,
 * <em>find</em>, and <em>connected</em> operations take linear time (in the
 * worst case) and the <em>count</em> operation takes constant time. For
 * alternate implementations of the same API, see {@link UF},
