...
/**
 * The {@code PatriciaSET} class provides an implementation of an unordered set,
 * with the restriction that the items (keys) are of class
 ...
 * <p>
 * This unordered set class implements PATRICIA (Practical Algorithm to Retrieve
 * Information Coded In Alphanumeric). In spite of the acronym, string keys are
 * not limited to alphanumeric content. A key may possess any string value, with
 * one exception: a zero-length string is not permitted.
 * <p>
 ...
 * <strong>~lg N</strong> for each <em>add</em>, <em>contains</em>, or
 ...
 * of the key (per <em>add</em>, <em>contains</em>, or <em>delete</em>
 * operation).
 * <p>
...
public class PatriciaSET implements Iterable<String> {
	...
	/*
	 * An inner Node class specifies the objects that hold each key. The b value
	 * indicates the relevant bit position.
	 */
	private class Node {
	...
	/**
	 * Unit tests the {@code PatriciaSET} data type. This test fixture runs a
