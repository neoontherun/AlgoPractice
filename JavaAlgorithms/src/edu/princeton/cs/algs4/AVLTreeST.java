...
/**
 * The {@code AVLTreeST} class represents an ordered symbol table of generic
 ...
 * {@code Comparable} interface and calls the {@code compareTo()} and method to
 * compare two keys. It does not call either {@code equals()} or
...
public class AVLTreeST<Key extends Comparable<Key>, Value> {
	 ...
	 * @param key
	 *            the key
	 * @return {@code true} if the symbol table contains {@code key} and
	 ...
	 * @throws IllegalArgumentException
	 *             unless {@code k} is between 0 and {@code size() -1 }
	 */
	 ...
	 *            the subtree
	 * @param k
	 *            the kth smallest key in the subtree
	...
	/**
	 * Adds the keys between {@code lo} and {@code hi} in the subtree to the
	 * {@code queue}.
	 * 
	 * @param x
	 *            the subtree
