 ...
 * merging operation to determine the longest common substring. For an alternate
...
public class LongestCommonSubstring {
	...
	/**
	 * Unit tests the {@code lcs()} method. Reads in two strings from files
	 * specified as command-line arguments; computes the longest common
	 * substring; and prints the results to standard output.
	 *
	 * @param args
