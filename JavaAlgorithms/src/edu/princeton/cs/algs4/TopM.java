 ...
 * transactions from standard input and prints the <em>m</em> largest ones to
 * standard output. This implementation uses a {@link MinPQ} of size at most
 * <em>m</em> + 1 to identify the <em>M</em> largest transactions and a
 * {@link Stack} to output them in the proper order.
 * <p>
