...
/**
 * The {@code AssignmentProblem} class represents a data type for computing an
 * optimal solution to an <em>n</em>-by-<em>n</em> <em>assignment problem</em>.
 * The assignment problem is to find a minimum weight matching in an
 * edge-weighted complete bipartite graph.
 * <p>
 * The data type supplies methods for determining the optimal solution and the
 * corresponding dual solution.
 * <p>
 * This implementation uses the <em>successive shortest paths algorithm</em>.
 * The order of growth of the running time in the worst case is O(<em>n</em>^3
 * log <em>n</em>) to solve an <em>n</em>-by-<em>n</em> instance.
 * <p>
...
public class AssignmentProblem {
	...
	/**
	 * Returns the column associated with the specified row in the optimal
	 * solution.
	 *
	 * @param i
	 *            the row index
	...
	/**
	 * Unit tests the {@code AssignmentProblem} data type. Takes a command-line
	 * argument n; creates a random n-by-n matrix; solves the n-by-n assignment
	 * problem; and prints the optimal solution.
	 *
	 * @param args
