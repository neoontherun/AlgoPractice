 ...
 * two-dimensional axis-aligned rectagle with real-value coordinates. The
 * rectangle is <em>closed</em>—it includes the points on the boundary.
 * <p>
...
public final class RectHV {
	 ...
	 *             if any of {@code xmin}, {@code xmax}, {@code ymin}, or
	 *             {@code ymax} is {@code Double.NaN}.
	 * @throws IllegalArgumentException
	...
	/**
	 * Returns true if the two rectangles intersect. This includes <em>improper
	 * intersections</em> (at points on the boundary of each rectangle) and
	 * <em>nested intersctions</em> (when one rectangle is contained inside the
	 * other)
	 *
	 * @param that
	 *            the other rectangle
	 * @return {@code true} if this rectangle intersect the argument rectangle
	 ...
	 * @param p
	 *            the point
	 * @return the Euclidean distance between the point {@code p} and the
	 *         closest point on this rectangle; 0 if the point is contained in
	 *         this rectangle
	 */
	...
	/**
	 * Returns the square of the Euclidean distance between this rectangle and
	 * the point {@code p}.
	 *
	 * @param p
	 *            the point
	 * @return the square of the Euclidean distance between the point {@code p}
	 *         and the closest point on this rectangle; 0 if the point is
