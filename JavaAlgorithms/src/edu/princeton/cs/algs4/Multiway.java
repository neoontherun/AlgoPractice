...
/**
 * The {@code Multiway} class provides a client for reading in several sorted
 * text files and merging them together into a single sorted text stream. This
 * implementation uses a {@link IndexMinPQ} to perform the multiway merge.
 * <p>
...
public class Multiway {
	...
	// merge together the sorted input streams and write the sorted result to
	// standard output
