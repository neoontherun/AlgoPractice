...
/**
 * The {@code AmericanFlag} class provides static methods for sorting an array
 * of extended ASCII strings or integers in-place using American flag sort. This
 * is a non-recursive implementation.
 * <p>
 ...
 * Engineering Radix Sort</a> by McIlroy and Bostic. For a version that uses
 * only one auxilary array, see {@link AmericanFlagX}.
 *
...
public class AmericanFlag {
	 ...
	 *
	 * @param args
	 *            the command-line arguments: "int" to read input as
